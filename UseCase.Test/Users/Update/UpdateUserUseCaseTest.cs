...
public class UpdateUserUseCaseTest
{
    ...
    public async Task Error_Name_Empty()
    {
        ...
        result.Where(ex => ex.GetErrors().Count == 1 && ex.GetErrors().Contains("Nome não pode ser vazio"));
    }
    ...
    public async Task Error_Email_Already_Exist()
    {
        ...
        result.Where(ex => ex.GetErrors().Count == 1 && ex.GetErrors().Contains("Email ja está registrado"));
    }
