...
public class ExpensesReadOnlyRepositoryBuilder
{
    ...
    public ExpensesReadOnlyRepositoryBuilder GettAll(User user, List<Expense> expenses)
    {
    ...
    {
        _repository.Setup(repository => repository.FilterByMonth(user, It.IsAny<DateOnly>()))
            .ReturnsAsync(expenses);
        return this;
    }   
